...
class FlutterTomtomNavigationView(
    ...
    // Routes which has been generated by the route planning
    private var routePlanningOption: RoutePlanningOptions? = null
...
//                safetyLocationsConfiguration = SafetyLocationsConfiguration(apiKey)
    ...
    private fun planRoute(routePlanningOptions: RoutePlanningOptions) {
        ...
        routePlanningOption = routePlanningOptions
    ...
    private val routeClickListener = { route: Route, mapDisplayRoute: com.tomtom.sdk.map.display.route.Route ->
